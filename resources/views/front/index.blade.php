		...
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card bg-transparent border-0">
					<img src="{{asset('web-assets/images/blog/1.jpg')}}" alt="" class="img-fluid rounded">
					...
					<div class="card-body mt-2">
						...
						<a href="{{route('webBlogSinglePage')}}" class="btn btn-small btn-solid-border btn-round-full text-white">Learn More</a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card border-0 bg-transparent">
					<img src="{{asset('web-assets/images/blog/2.jpg')}}" alt="" class="img-fluid rounded">
			...
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card border-0 bg-transparent">
					<img src="{{asset('web-assets/images/blog/3.jpg')}}" alt="" class="img-fluid rounded">
