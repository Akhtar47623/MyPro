		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="{{route('webIndexPage')}}">Home <span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						<li><a class="dropdown-item" href="{{route('webAboutPage')}}">Our company</a></li>
						<li><a class="dropdown-item" href="{{route('webPricingPage')}}">Pricing</a></li>
					</ul>
			  </li>
			   <li class="nav-item"><a class="nav-link" href="{{route('webServicesPage')}}">Services</a></li>
			   <li class="nav-item"><a class="nav-link" href="{{route('webServicesPage')}}">Portfolio</a></li>
			   <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown05">
						<li><a class="dropdown-item" href="{{route('webBlogGridPage')}}">Blog Grid</a></li>
						<li><a class="dropdown-item" href="{{route('webBlogSidebarPage')}}">Blog with Sidebar</a></li>

						<li><a class="dropdown-item" href="{{route('webBlogSinglePage')}}">Blog Single</a></li>
					</ul>
			  </li>
			   <li class="nav-item"><a class="nav-link" href="{{route('webContactPage')}}">Contact</a></li>
			</ul>
